...
redcap_field_validation <- c(NA,'date_mdy','integer',NA,NA,NA,NA,NA,NA)
...
redcap_widget_map <- tibble(redcap_field_type, redcap_field_validation, shinyREDCap_widget_function)
